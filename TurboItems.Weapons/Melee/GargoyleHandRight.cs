...
{
    class GargoyleHandRight : AdvancedGunBehaviour
    {
        public static int Add()
        {
            Gun gun = ETGMod.Databases.Items.NewGun("Gargoyle's Right Hand", "gargoyle_hand_right");
            Game.Items.Rename("outdated_gun_mods:gargoyles_right_hand", "turbo:gargoyles_right_hand");
            var behav = gun.gameObject.AddComponent<GargoyleHandRight>();
            behav.overrideNormalFireAudio = "Play_WPN_blasphemy_shot_01";
            behav.preventNormalFireAudio = true;
            gun.SetShortDescription("Rock-hard and ready to rumble");
            gun.SetLongDescription("The right hand of a gargoyle. Can stun enemies, due to it's blocky, hard structure.");
            ...
            gun.encounterTrackable.EncounterGuid = "never gonna let you down";
            ...
            VFXPool MirrorSwordVFXLibrary = VFXLibrary.CreateMuzzleflash("gargoyle_hand_right_slash", new List<string> { "gargoyle_hand_right_slash_001", "gargoyle_hand_right_slash_002", "gargoyle_hand_right_slash_003", "gargoyle_hand_right_slash_004", }, 10, new List<IntVector2> { new IntVector2(38, 45), new IntVector2(38, 45), new IntVector2(38, 45), new IntVector2(38, 45), },
            ...
            GargoyleRightID = gun.PickupObjectId;
            return gun.PickupObjectId;
        }
        public static int GargoyleRightID;
        public GargoyleHandRight()
        {
