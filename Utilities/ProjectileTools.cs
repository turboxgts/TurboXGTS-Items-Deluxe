    ...
    public static class ProjectileTools
    {
        ...
        public static void SetProjectileSpriteRight(this Projectile proj, string name, int pixelWidth, int pixelHeight, int? overrideColliderPixelWidth = null, int? overrideColliderPixelHeight = null)
        {
            try
            {
                ...
                ETGModConsole.Log("If something goes haywire with projectile sprites, you done messed up the method in the mod porting guide.");
                // Next 2 lines are from the Mod Porting guide - if something goes wrong, LOOK HERE!
